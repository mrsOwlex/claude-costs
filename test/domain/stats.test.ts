...
import { daysBetween, percentile, calculateRequestStats } from '../../src/domain/stats.js';
...
test('calculateRequestStats computes averages', () => {
  const requests = [
    { tokens: { input: 100, output: 50, cacheRead: 200, cacheCreate5m: 0, cacheCreate1h: 0, cacheCreateUnknown: 0, cacheCreate: 0, cacheCreateTotal: 0 } },
    { tokens: { input: 200, output: 100, cacheRead: 300, cacheCreate5m: 0, cacheCreate1h: 0, cacheCreateUnknown: 0, cacheCreate: 0, cacheCreateTotal: 0 } },
  ] as Request[];
...
test('calculateRequestStats computes cache ratios', () => {
  const requests = [
    { tokens: { input: 100, output: 50, cacheRead: 100, cacheCreate5m: 0, cacheCreate1h: 0, cacheCreateUnknown: 0, cacheCreate: 0, cacheCreateTotal: 0 } },
  ] as Request[];
  const stats = calculateRequestStats(requests, 1);
