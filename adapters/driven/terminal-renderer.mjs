import { bold, dim, green, red, yellow, formatTokens, formatUSD, formatPerMTok, heading, table, formatPercent, formatBytes, formatCostRange } from './format.mjs';
...
export function budgetStatusText(model, args) {
...
export function selectComparisonRows(comparisons, args) {
...
export function printTokenUsage(data) {
...
export function printClaudeCosts(data, traceCost, months) {
...
export function printComparison(comparisons, args, months, requestStats, data) {
...
export function printSummary(traceCost, args, months) {
  console.log('');
