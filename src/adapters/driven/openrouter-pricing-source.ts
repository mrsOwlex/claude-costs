...
export async function fetchOpenRouterModels(): Promise<OpenRouterModel[] | null> {
  try {
...
export function updateComparisonFromOpenRouter(models: ComparisonModel[], orModels: OpenRouterModel[]): void {
...
function applyOpenRouterModel(model: ComparisonModel, orModel: OpenRouterModel): void {
...
function isPositivePrice(value: string | undefined | null): boolean {
  return value != null && Number(value) > 0;
}

function applyOpenRouterLimits(model: ComparisonModel, orModel: OpenRouterModel): void {
